...
async function main() {
    ...
    console.log("Alice's SS58-Encoded Address:", 
    // deriveAddress(alice.publicKey, 6) // TODO, use correct prefix
    index_1.deriveAddress(alice.publicKey, 6) // TODO, use correct prefix
    );
    ...
    const unsigned = index_1.methods.balances.transfer({
        ...
        dest: "gXCcrjjFX3RPyhHYgwZDmw8oe4JFpd5anko3nTY8VrmnJpe",
    }, {
